...
export function DemoEventModal({ onClose, visible = true }) {
	...
	const callouts = [
		...
		},
		{
			label: "Notes",
			description:
				"Add notes with @mentions to link related events together.",
			offset: { mainAxis: 12, crossAxis: 28 },
		},
	];
			...
			<OnboardingTour.Target id="demo-event-modal">
				...
				>
					<Group justify="space-between" mb="md">
						<Text fw={600}>Edit Event (Demo)</Text>
							...
							<Popover.Target>
								<Box>
									...
									>
										...
										<Text size="xs" c="dimmed">
											When linked to Canvas, submit files,
											text, or URLs directly from here.
										</Text>
									</Box>
								</Box>
							</Popover.Target>
